...
<div class="content content-narrow">
    <!-- Register Forms -->
    <h2 class="content-heading">Edit state</h2>
    <div class="row">
        <div class="col-lg-4">
            <!-- Bootstrap Register -->
            <div class="block block-themed">
                ...
                <div class="block-content">
                    {!! Form::model($state,["method"=>"PATCH","action" => ['StatesController@update',$state->id],"class"=>"form-horizontal push-5-t"]) !!}
                        ...
                        <div class="form-group">
                            <div class="col-xs-12">
                                ...
                                {!! Form::submit("Update state",["class"=>"btn btn-sm btn-success"]) !!}
                            </div>
                        </div>
                    {!! Form::close() !!}
                </div>
