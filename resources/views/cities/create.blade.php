...
<div class="content content-narrow">
    <!-- Register Forms -->
    <h2 class="content-heading">Add City</h2>
    <div class="row">
        <div class="col-lg-4">
            <!-- Bootstrap Register -->
            <div class="block block-themed">
                ...
                <div class="block-content">
                    {!! Form::open(["url" => "admin/cities","class"=>"js-validation-bootstrap form-horizontal push-5-t"]) !!}
                        <div class="form-group">
                        {!! Form::label("country","Select Country *",["class"=>"col-xs-12","for"=>"country_id"]) !!}
                            <div class="col-sm-12">
                        ...
                        <div class="form-group">
                           {!! Form::label("name","City Name *",["class"=>"col-xs-12","for"=>"name"]) !!}
                            <div class="col-xs-12">
                        ...
                        <div class="form-group">
                            <div class="col-xs-12">
                                ...
                                {!! Form::submit("Add City",["class"=>"btn btn-sm btn-success"]) !!}
                            </div>
                        </div>
                    {!! Form::close() !!}
                </div>
