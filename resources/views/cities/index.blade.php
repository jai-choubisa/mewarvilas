                    ...
                    <div class="row items-push">
                        ...
                        <div class="col-sm-5 text-right hidden-xs">
                            <ol class="breadcrumb push-10-t">
                                <li>cities</li>
                                <li><a class="link-effect" href="{{ URL::asset('cities.index') }}">Index</a></li>
                            </ol>
                        </div>
                    </div>
                </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                                ...
                                                {!! Form::open(['method'=>'DELETE','route'=>['admin.cities.destroy',$state->id]]) !!}
                                                <div class="form-group">
                                                    <a href="{{ URL::asset('admin/cities/'.$state->id.'/edit') }}" class="btn btn-xs btn-default" data-toggle="tooltip" title="Edit Client"><i class="fa fa-pencil"></i></a>
