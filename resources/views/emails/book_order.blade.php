							...
							<td align="center">
								...
								<table width="100%" align="center" cellspacing="0" cellpadding="0" border="0" class="full-width" >
									<tbody>
										...
										<tr>
											<td class="font_fix" style="font-size:16px; mso-line-height-rule:exactly; line-height:20px; color:#555555; font-weight:bold; font-family: 'Montserrat', sans-serif;">Hi Customer,</td>
										</tr>
										<tr>
											<td height="20" style="line-height:20px; " ></td>
										</tr>
										<tr >
											<td style="font-size:14px; mso-line-height-rule:exactly; line-height:18px; color:#95a5a6; font-weight:normal; font-family: Arial, Helvetica, sans-serif;">Thank you for your order!
											</td>
										</tr>
										<tr><td style="font-size:14px; mso-line-height-rule:exactly; line-height:18px; color:#95a5a6; font-weight:normal; font-family: Arial, Helvetica, sans-serif;">Please find below the summary of your order <b>{{ $order->booking_no }}</b></td></tr>
										<tr>
											<td height="20" style="line-height:20px; " ></td>
										</tr>
										<tr>
										...
										<table class="mytable">
											...
											<tr>
												<td><h2>{{ $restaurant->restaurant_name }}</h2><img src="http://www.mewarvilas.com{{ $restaurant->banner_image_path }}" height="100px" /></td>
