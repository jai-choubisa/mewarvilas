							...
							<td align="center">
								...
								<table width="100%" align="center" cellspacing="0" cellpadding="0" border="0" class="full-width" >
									<tbody>
										...
										<tr>
											<td class="font_fix" style="font-size:16px; mso-line-height-rule:exactly; line-height:20px; color:#555555; font-weight:bold; font-family: 'Montserrat', sans-serif;"><h2>Message from {{ $name_contact }} {{ $lastname_contact }}<br>Email - {{ $email_contact }}<br>Phone - {{ $phone_contact }}</h2></td>
										</tr>
										<tr>
											<td height="20" style="line-height:20px; " ></td>
										</tr>
										<tr >
											<td style="font-size:14px; mso-line-height-rule:exactly; line-height:18px; color:#95a5a6; font-weight:normal; font-family: Arial, Helvetica, sans-serif;">@foreach($messageLines as $m)
														{{ $m }}<br />
													  @endforeach	 
											</td>
										</tr>
