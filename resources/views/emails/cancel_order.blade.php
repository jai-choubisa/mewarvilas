...
<td height="25" valign="middle" align="left">
	...
	<table width="160" align="left" cellspacing="0" cellpadding="0" border="0" class="full-width">
		<tbody>
			<tr>
				<td height="34" valign="middle" align="center" class="center-stack" ><a href="{{ URL::asset('/') }}"><img src="http://www.mewarvilas.com/assets/img/logo-dark.png" width="160" height="34" alt="MewarVilas" /></a></td>
			</tr>
		</tbody>
	</table>
	<!-- End Logo -->
		...
		<tbody>
			<tr>
				<td height="34" valign="bottom" align="right" class="center">
					<a style="text-decoration: none; border:0;" href="#"><img src="http://www.mewarvilas.com/assets/img/fb_bt.jpg" width="27" height="27" alt="Facebook" /></a>
				&nbsp;
					<a style="text-decoration: none; border:0" href="#"><img src="http://www.mewarvilas.com/assets/img/google_pl_bt.jpg" width="27" height="27" alt="Google plus" /></a>
				&nbsp;
					<a style="text-decoration: none; border:0" href="#"><img src="http://www.mewarvilas.com/assets/img/twitter_bt.jpg" width="27" height="27" alt="Youtube" /></a>													
				</td>
			</tr>
		</tbody>
	</table>
							...
							<td align="center">
								...
								<table width="100%" align="center" cellspacing="0" cellpadding="0" border="0" class="full-width" >
									<tbody>
										...
										<tr>
											<td class="font_fix" style="font-size:16px; mso-line-height-rule:exactly; line-height:20px; color:#555555; font-weight:bold; font-family: 'Montserrat', sans-serif;">CANCELLATION CONFIRMATION</td>
										</tr>
										<tr>
											<td class="font_fix" style="font-size:16px; mso-line-height-rule:exactly; line-height:20px; color:red; font-weight:bold; font-family: 'Montserrat', sans-serif;">Order No.:{{ $order->booking_no }}</td>
										</tr>
										<tr>
											<td class="font_fix" style="font-size:16px; mso-line-height-rule:exactly; line-height:20px; color:#555555; font-weight:bold; font-family: 'Montserrat', sans-serif;">Hi {{ $myuser->name }},</td>
										</tr>
										<tr>
											<td height="20" style="line-height:20px; " ></td>
										</tr>
										<tr >
											<td style="font-size:14px; mso-line-height-rule:exactly; line-height:18px; color:#95a5a6; font-weight:normal; font-family: Arial, Helvetica, sans-serif;"><p>Greetings from MewarVilas.com. We would like to confirm the cancellation of your order with booking no. {{ $order->booking_no }} raised on <?php  echo date("d M Y", strtotime($order->date)); ?>.</p>
<p>Request you to write us at themewarvilas@gmail.com In case of any query. We hope to see you booking restaurant with us again soon.</p><hr>
<p>Thanks for choosing MewarVilas.com</p>
											</td>
										</tr>
							...
							<td valign="top" align="center">
								...
								<table align="center" cellspacing="0" cellpadding="0" border="0" class="full-width" width="100%">
									<tbody>
										...
										<tr>
											<td class="font_fix" style="font-family: 'Montserrat', sans-serif; font-size:28px;mso-line-height-rule:exactly; line-height:28px; font-weight:bold; color:#ffffff;text-decoration:none !important; " align="center">+91 9460718986</td>
										</tr>																																						
										<tr>
											<td class="font_fix" style="font-size:12px; font-family: 'Montserrat', sans-serif; line-height:14px; color:#ffffff; font-weight:bold; padding-top:5px" align="center"><a href="#" style="color:#ffffff;text-decoration:none !important;">themewarvilas@gmail.com</a> - <a href="#" style="color:#ffffff;text-decoration:none !important; ">www.mewarvilas.com</a></td>
										</tr>																			
										<tr>
											<td height="10">&nbsp;</td>
										</tr>
...
<table bgcolor="#e04f67" width="100%" cellspacing="0" cellpadding="0" border="0" class="full-width">
	<tbody>
		<tr>
			<td valign="bottom" align="left" height="71"><img src="http://www.mewarvilas.com/assets/img/bg_footer.jpg" class="emailImage" alt="Main banner" border="0" width="600" height="71" /></td>
		</tr>
	</tbody>
</table>
<!-- Section img footer  -->
		...
		<tr>	
			<td align="center">														
				...
				<table width="550" align="center" cellspacing="0" cellpadding="0" border="0" class="content-width">
					<tbody>
						<tr>
							<td  align="center" valign="middle" style="font-family: Arial, Helvetica, sans-serif;font-size:11px; font-weight:normal; color:#cccccc; padding-top:10px; padding-bottom:10px"><strong>Copyright © 2016 MewarVilas</strong></td>
						</tr>
					</tbody>
				</table>
				<!-- End Space -->
