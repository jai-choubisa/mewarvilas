                    ...
                    <div class="row items-push">
                        <div class="col-sm-7">
                            <h1 class="page-heading">
                               Customer Users <small>full list.</small>
                            </h1>
                        </div>
                        <div class="col-sm-5 text-right hidden-xs">
                            <ol class="breadcrumb push-10-t">
                                <li>Home</li>
                                <li>Users</li>
                                <li><a class="link-effect" href="{{ URL::asset('admin/customer-users') }}">Customer Users</a></li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="content">
                    ...
                    <div class="block">
                        <div class="block-header">
                            <h3 class="block-title">Customer Users Information <small>Full</small></h3>
                        </div>
