        ...
        <div class="row add_bottom_45">
            ...
            <div class="col-md-4 other_tours">
                ...
                <ul>
                    ...
                    <li><a href="{{ URL::asset('restaurants/'.$restaurant->slug) }}"><i class="icon-restaurant"></i>{{ $restaurant->restaurant_name }}<span class="other_tours_price">Rs {{ $restaurant->price}}</span></a>
                    </li>
                    @endforeach
                </ul>
            </div>
