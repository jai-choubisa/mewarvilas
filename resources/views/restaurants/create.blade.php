    ...
    <div class="row items-push">
        <div class="col-sm-7">
            <h1 class="page-heading">
                Create New Restaurant <small>Add restaurant to the website.</small>
            </h1>
        </div>
...
<div class="content content-narrow">
    <!-- Mega Form -->
    <h2 class="content-heading">Create New Restaurant</h2>
    <div class="block block-bordered">
        <div class="block-header bg-gray-lighter">
            ...
            <h3 class="block-title">Please Fill the form below to create a new Restaurant.</h3>
        </div>
        <div class="block-content">
        {!! Form::open(["url" => "admin/restaurants","class"=>"form-horizontal push-10-t push-10",'novalidate' => 'novalidate', "files" => true]) !!}
            <div class="row">
                    <div class="col-sm-7">
                        <div class="form-group">
                            ...
                            <div class="col-xs-6">
                                {!! Form::label(null,"Email *",["for"=>"email"]) !!}
                    ...
                    <div class="col-sm-5">
                        <div class="form-group">
                            <div class="col-xs-12">
                                {!! Form::label(null,"Password *",["for"=>"password"]) !!}
                ...
                <div class="form-group">
                    <div class="col-xs-12">
                        {!! Form::submit("Create Restaurant",["class"=>"btn btn-warning"]) !!}
                    </div>
                </div>
            {!! Form::close() !!}
        </div>
