...
<div class="content content-narrow">
    <!-- Register Forms -->
    <h2 class="content-heading">Edit Deal</h2>
    <div class="row">
        <div class="col-lg-6">
            <!-- Bootstrap Register -->
            <div class="block block-themed">
                ...
                <div class="block-content">
                    {!! Form::model($deal,["method"=>"PATCH","action" => ['DealsController@update',$deal->id],"class"=>"form-horizontal push-5-t"]) !!}
                           ...
                           {!! Form::label("date","Valid Period",["class"=>"col-md-4 control-label"]) !!}
                            <div class="col-md-8">
                                <div class="input-daterange input-group" id="datepicker" data-date-format="mm/dd/yyyy">
                                    {!! Form::text("from_date",$fromdate,["class"=>"form-control","placeholder"=>"From date","id"=>"example-daterange1"]) !!}
                                    <span class="input-group-addon"><i class="fa fa-chevron-right"></i></span>
                                    {!! Form::text("to_date",$todate,["class"=>"form-control","placeholder"=>"Till date","id"=>"example-daterange2"]) !!}
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="col-xs-12">
                                ...
                                {!! Form::submit("Update deal",["class"=>"btn btn-sm btn-success"]) !!}
                            </div>
                        </div>
                    {!! Form::close() !!}
                </div>
