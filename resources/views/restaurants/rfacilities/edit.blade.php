        ...
        <div class="col-lg-6">
            ...
            <div class="block block-themed">
                ...
                <div class="block-content">
                    {!! Form::model($rfacility,["method"=>"PATCH","action" => ['RfacilitiesController@update',$rfacility->id],"class"=>"form-horizontal push-5-t"]) !!}
                       <div class="form-group">
                        ...
                        <div class="form-group">
                            {!! Form::label("facility","Facility *",["class"=>"col-xs-12","for"=>"name"]) !!}
                            <div class="col-sm-12">
                                {!! Form::select('name',  (['0' => '--Select Facility--'] + $facilities),null,["class"=>"form-control","size"=>'1']) !!}
                            </div>
                        </div> 
                        <div class="form-group">
                            <div class="col-xs-12">
