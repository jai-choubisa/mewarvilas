...
<div class="content content-narrow">
    <!-- Register Forms -->
    <h2 class="content-heading">Add Map</h2>
    <div class="row">
        <div class="col-lg-6">
            <!-- Bootstrap Register -->
            <div class="block block-themed">
                ...
                <div class="block-content">
                    {!! Form::open(["url" => "admin/restaurants/maps","class"=>"form-horizontal push-5-t"]) !!}
                        ...
                        <div class="form-group">
                            <div class="col-xs-12">
                                ...
                                {!! Form::submit("Add map",["class"=>"btn btn-sm btn-success"]) !!}
                            </div>
                        </div>
                    {!! Form::close() !!}
                </div>
