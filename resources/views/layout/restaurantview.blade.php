...
<!--[if gt IE 9]><!--> <html class="no-focus"> <!--<![endif]-->
    <head>
        ...
        <title>MewarVilas -@if(Session::get('radmin_name')) {{ Session::get('radmin_name') }} Restaurant Admin @endif</title>
        ...
        <link rel="shortcut icon" href="_assets/img/favicons/favicon.png">
    ...
    <body>
                ...
                <div id="sidebar-scroll">
                    ...
                    <div class="sidebar-content">
                        ...
                        <div class="side-content">
                            <ul class="nav-main">
                                <li>
                                    <a href="{{ URL::asset('restaurantview/dashboard') }}"><i class="si si-speedometer"></i><span class="sidebar-mini-hide">Dashboard</span></a>
                                </li>
                                <li>
                                    <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-wrench"></i><span class="sidebar-mini-hide">Orders</span></a>
                                    <ul>
                                        <li>
                                            <a href="{{ URL::asset('restaurantview/daily-orders') }}">Daily Orders</a>
                                        </li>
                                        <li>
                                            <a href="{{ URL::asset('restaurantview/orders') }}">All Orders</a>
                                        </li>
                                ...
                                <li>
                                    <a href="{{ URL::asset('restaurantview/profile') }}"><i class="si si-speedometer"></i><span class="sidebar-mini-hide">Manage Profile</span></a>
                                </li>
                                <li>
                                    <a href="{{ URL::asset('restaurantview/images') }}"><i class="si si-speedometer"></i><span class="sidebar-mini-hide">Manage Images</span></a>
                                </li>
                                <li>
                                    <a href="{{ URL::asset('restaurantview/events') }}"><i class="si si-speedometer"></i><span class="sidebar-mini-hide">Manage Events</span></a>
                                </li>
                            </ul>
                        </div>
                        <!-- END Side Content -->
            ...
            <header id="header-navbar" class="content-mini content-mini-full">
                    ...
                    <li>
                        <div class="btn-group">
                            <button class="btn btn-default btn-image dropdown-toggle" data-toggle="dropdown" type="button">
                                <img src="{{ URL::asset("_assets/img/avatars/avatar10.jpg") }}" alt="Avatar">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                ...
                                <li>
                                    <a tabindex="-1" href="{{ URL::asset("restaurantview/profile") }}">
                                        <i class="si si-user pull-right"></i>
                                        Profile
                                    </a>
                                </li>
                                <li>
                                    <a tabindex="-1" href="{{ URL::asset("restaurants/".Session::get('radmin_id')) }}">
                ...
                <ul class="nav-header pull-left">
                    ...
                    <li>
                        ...
                        <a class="btn btn-primary pull-right" href="{{ URL::asset("restaurants/".Session::get('radmin_id')) }}" title="Restaurant Front Page"/>
                            <i class="si si-rocket"></i>
                        </a>
                    </li>
                    @if(Session::get('radmin_name'))
                    <li>
                        <!-- Toggle class helper (for .js-header-search below), functionality initialized in App() -> uiToggleClass() -->
                        <h2>{{ Session::get('radmin_name') }} Restaurant Admin</h2>
                    </li>
                    @endif
                </ul>
        ...
        <script>
            $(function () {
                ...
                App.initHelpers(['datepicker','slick','magnific-popup']);
            });
